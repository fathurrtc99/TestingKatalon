...
WebUI.callTestCase(findTestCase('1TC_Login'), [('Username') : 'Admin', ('Password') : 'admin123'], FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('NEW_OBJECT/Create_Employee/button_Add Employee_oxd-icon-button employee-image-action'))

WebUI.uploadFile(findTestObject('NEW_OBJECT/Create_Employee/button_Add Employee_oxd-icon-button employee-image-action'), 
    'C:\\folder_data_katalon\\profile.jpg')
